...
import { AddToCartButton, Price } from '@commercelayer/react-components'
      ...
      <div className="flex flex-1 flex-col p-6">
        ...
        <div className="mt-auto flex items-center justify-between gap-4 pt-6">
          <div className="inline-flex items-center gap-3 rounded-full bg-[#f1f1f1] px-3 py-1">
            <Price
              skuCode={sku.code}
              className='text-md font-semibold tracking-tight text-slate-950'
              compareClassName='text-sm text-slate-500 line-through'
            />
          </div>
          <AddToCartButton
